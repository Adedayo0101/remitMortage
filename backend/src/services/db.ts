...
/**
 * Retrieves historical in-app notifications for a user's wallet address in reverse-chronological order.
 */
export async function getUserInAppNotifications(walletAddress: string, limit = 50) {
 ...
 */
export async function markInAppNotificationRead(id: string, walletAddress: string) {
...
/**
 * Marks all in-app notifications for a user as read.
 */
export async function markAllInAppNotificationsRead(walletAddress: string) {
  return prisma.inAppNotification.updateMany({
...
/**
 * Ingests a new in-app notification for a given wallet address.
 */
