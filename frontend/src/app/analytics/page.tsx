      ...
      <main className="max-w-7xl mx-auto px-6 pt-28 pb-20">
        ...
        <div className="mb-10 text-center md:text-left">
          ...
          <p className="text-[var(--text-secondary)] text-lg max-w-2xl">
            Real-time transparency metrics for the RemitMortgage lending pools, borrow activity, and
            stablecoin flows.
          </p>
        </div>
        ...
        {loading && (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            {[...Array(4)].map((_, i) => (
              <div
                key={i}
                className="h-32 bg-[var(--bg-card)] border border-[var(--border-color)] rounded-xl animate-pulse"
              />
            ))}
          </div>
        )}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
              ...
              <div className="glass-card p-6 lg:col-span-2 flex flex-col justify-between">
                <div className="mb-4">
                  ...
                  <p className="text-xs text-[var(--text-secondary)]">
                    Monthly deposit, repayment, and disbursement volumes
                  </p>
                </div>
              ...
              <div className="glass-card p-6 flex flex-col justify-between">
                <div className="mb-2">
                  ...
                  <p className="text-xs text-[var(--text-secondary)]">
                    Distribution of active, repaid, and defaulted loans
                  </p>
                </div>
            ...
            <div className="glass-card p-6">
              <div className="mb-6 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-[var(--text-secondary)]">
                    Live ledger events representing pool interactions
                  </p>
                </div>
                    ...
                    <li key={activity.id}>
                      <div className="relative pb-8">
                        {activityIdx !== overview.recentActivity.length - 1 ? (
                          <span
                            className="absolute top-4 left-4 -ml-px h-full w-0.5 bg-[var(--border-color)]"
                            aria-hidden="true"
                          />
                        ) : null}
                        <div className="relative flex space-x-3 items-center">
                          <div>
                            <span
                              className={`h-8 w-8 rounded-lg flex items-center justify-center ring-8 ring-[var(--bg-primary)] ${
